...
<style>
    ...
    * {
    ...
    /* Header styling */
    .header-content {
        background: linear-gradient(90deg, #1A237E, #3F51B5); /* Adjusted for professional look */
        color: #ffffff;
        text-align: center;
        padding: 0.5rem;
        display: flex;
    ...
    /* Footer styling */
    .footer-content {
        background: #1A237E; /* Matches header styling */
        color: white;
        font-size: 1rem;
        text-align: center;
        padding: 1rem;
                ...
                <div class="account-info">
                    ...
                    <div class="user-menu">
                        <div class="user-header">
                            <img src="{{ asset('assets/images/user/profile.png') }}" alt="User Image">
                            <span>John Doe</span>
                        </div>
